...
var de = [rows][cols]Key{
    .{
        ...
        Key{.label="F12", .char='?'}, Key{.label="Druck", .char='?'}, Key{.label="Rollen", .char='?'}, Key{.label="Pause", .char='?'},
    }, .{
        ...
        Key{.label="´", .char='´'}, Key{.label="<-", .char='?'}, Key{.label="Einfg", .char='?'}, Key{.label="Pos 1", .char='?'},
    }, .{
        ...
        Key{.label="*", .char='*'}, Key{.label="Enter", .char='?'}, Key{.label="Entf", .char='?'}, Key{.label="Ende", .char='?'},
    }, .{
        ...
        Key{.label="#", .char='#'}, Key{.label="Enter", .char='?'}, Key{.label="Bild auf", .char='?'}, Key{.label="Hoch", .char='?'},
    }, .{
        ...
        Key{.label="Umsch", .char='?'}, Key{.label="", .char='?'}, Key{.label="Hoch", .char='?'}, Key{.label="", .char='?'},
    }, .{
        Key{.label="Strg", .char='M'}, Key{.label="Symbol", .char='?'}, Key{.label="Alt", .char='A'}, Key{.label="Space", .char=' '}, 
        Key{.label="Space", .char=' '}, Key{.label="Space", .char=' '}, Key{.label="Space", .char=' '}, Key{.label="Space", .char=' '}, 
        Key{.label="Space", .char=' '}, Key{.label="Alt Gr", .char='?'}, Key{.label="Symbol", .char='?'}, Key{.label="Menü", .char='?'}, 
        Key{.label="Strg", .char='M'}, Key{.label="Links", .char='?'}, Key{.label="Runter", .char='?'}, Key{.label="Rechts", .char='?'}
    }
};
...
pub fn write() anyerror!void {
    for (de) | row, y | {
        for (row) | col, x | {
           try term.writeAt(x * 7 + 1, y + 1, "{s}", .{col.label});
        }
    }
}